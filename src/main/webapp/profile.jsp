        ...
        <div class="col-sm-4">
            ...
            <form method="post" action="/updateProfile">
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="email" readonly value="<%=user.getEmail()%>" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">FULLNAME</label>
                    <input type="text" class="form-control" name="full_name" value="<%=user.getFullname()%>" required>
                </div>
